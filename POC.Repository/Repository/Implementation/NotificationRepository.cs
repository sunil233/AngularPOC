    ...
    public class NotificationRepository : INotificationRepository
    {
        ...
        public void DisableExistingNotifications()
        {
            try
            {
                using (var _context = new DatabaseContext())
                {
                    var queryNotificationsTB = (from NotificationsTB in _context.NotificationsTBs
                                                select NotificationsTB).ToList();
                    foreach (var NotificationsTB in queryNotificationsTB)
                    {
                        NotificationsTB.Status = "D";
                    }
