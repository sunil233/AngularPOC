...
@Component({
  selector: 'admin-dashboard',
    ...
    providers: [AdminDashboardService, AdminTimeSheetService] 
})
export class DashboardComponent implements OnInit {
    ...
    panelheader: string = "";
    panelClass: string = ""
    constructor(private dashboardService: AdminDashboardService, private adminTimeSheetService: AdminTimeSheetService, private router: Router) {
        ...
        switch (gridaction.action) {
            case "view":
                ...
                switch (timesheetstatus) {
                    case 'Saved':
                        this.router.navigate(['/admin/timesheet', timeSheetMasterID]);
                        break;
                    case 'Submitted':
                        this.router.navigate(['/admin/timesheet', timeSheetMasterID]);
                        break;
    ...
    LoadData(divName): void {
        ...
        switch (divName) {
            case 'recent':
                ...
                this.dashboardbusy = this.adminTimeSheetService.GetTimeSheetsByStatus(this.userId, Status.Save).subscribe(tsdetails => {
            ...
            case 'submitted':
                ...
                divRejectedHours.removeClass("red-triangle-down");
                divApprovedHours.removeClass("lightgreen-triangle-down");
                this.dashboardbusy = this.adminTimeSheetService.GetTimeSheetsByStatus(this.userId, Status.Submit).subscribe(tsdetails => {
                    this.timesheetdetails = tsdetails;
            ...
            case 'rejected':
                ...
                divRecentSubmissions.removeClass("green-triangle-down");
                divApprovedHours.removeClass("lightgreen-triangle-down");
                this.dashboardbusy = this.adminTimeSheetService.GetTimeSheetsByStatus(this.userId, Status.Reject).subscribe(tsdetails => {
                    this.timesheetdetails = tsdetails;
                });
                break;
            case 'approved':
                ...
                divRejectedHours.removeClass("red-triangle-down");
                divRecentSubmissions.removeClass("green-triangle-down");
                this.dashboardbusy = this.adminTimeSheetService.GetTimeSheetsByStatus(this.userId, Status.Approve).subscribe(tsdetails => {
                    this.timesheetdetails = tsdetails;
                });
                break;
        }
