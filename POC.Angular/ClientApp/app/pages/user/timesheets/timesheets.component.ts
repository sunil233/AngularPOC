...
export class UserTimeSheetsComponent implements OnInit {
    ...
    constructor(private _userTimeSheetService: UserTimeSheetService, private _adminTimeSheetService: AdminTimeSheetService, private route: ActivatedRoute, private toastr: ToastrService) {
